    ...
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="glass-effect rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500">
                    <span class="font-mono bg-gray-100 px-2 py-1 rounded"><?php echo e(request()->path()); ?></span>
                </p>
            </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-gray-400 text-sm">
                &copy; <?php echo e(date('Y')); ?> TernakPark Wonosalam. All rights reserved.
            </p>
        </div>
    </div>
...
<?php /**PATH D:\game\Aplikasi_Skripsi\frontend-laravel\resources\views/errors/404.blade.php ENDPATH**/ ?>