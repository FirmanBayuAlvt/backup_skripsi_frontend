                    ...
                    <div class="mt-4">
                        <form id="record-weight-form" class="space-y-4 text-left">
                            ...
                            <div>
                                ...
                                <input type="date" name="record_date" id="record_date" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" value="<?php echo e(date('Y-m-d')); ?>">
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\game\Aplikasi_Skripsi\frontend-laravel\resources\views/livestocks/index.blade.php ENDPATH**/ ?>