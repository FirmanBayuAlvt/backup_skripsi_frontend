...
<head>
    ...
    <title>@yield('title', 'Dashboard') - TernakPark Wonosalam</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('images/Logo Ternakpark Wonosalam.png') }}">
    ...
    <div class="flex items-center space-x-4 group cursor-pointer">
        <div class="relative">
            <div
                ...
                <img
                    src="{{ asset('images/Logo Ternakpark Wonosalam.png') }}"
                    alt="TernakPark Logo"
                                ...
                                @foreach ($navItems as $item)
                                    <li>
                                        <a href="{{ route($item['route']) }}"
                                            class="@if ($currentRoute == $item['route'] || str_contains($currentRoute, $item['route'])) nav-item-active text-white @else text-green-100 hover:text-white hover:bg-white/5 @endif group flex items-center gap-x-4 rounded-2xl p-4 text-sm leading-6 font-semibold transition-all duration-300 shadow-sm">
                                            <div
                ...
                <div class="flex flex-1 gap-x-6 self-stretch">
                    ...
                    <div class="flex flex-1 items-center">
                        <div class="flex items-center space-x-4">
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">@yield('header-title', 'Dashboard')</h1>
                                <nav class="flex text-sm text-gray-600 mt-1">
                                    <ol class="flex items-center space-x-2">
                                        ...
                                        <li class="text-primary-600 font-semibold">@yield('header-title', 'Dashboard')</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
