...
@section('title', 'Laporan - TernakPark')
        ...
        <div class="card">
            ...
            <div class="stats">
                <div class="stat-item">
                    ...
                    <span class="value">{{ $totalLivestocks ?? 0 }}</span>
                </div>
                <div class="stat-item">
                    <span class="label">Total Kandang</span>
                    <span class="value">{{ $totalPens ?? 0 }}</span>
                </div>
                <div class="stat-item">
                    <span class="label">Jenis Pakan</span>
                    <span class="value">{{ $totalFeedTypes ?? 0 }}</span>
                </div>
            </div>
            <a href="{{ route('reports.performance') }}" class="btn">Lihat Detail</a>
        </div>
        ...
        <div class="card">
            ...
            <div class="stats">
                <div class="stat-item">
                    ...
                    <span class="value">{{ $recentData['livestocks_added'] ?? 0 }}</span>
                </div>
                <div class="stat-item">
                    <span class="label">Konsumsi Pakan (kg)</span>
                    <span class="value">{{ $recentData['feed_consumption'] ?? 0 }}</span>
                </div>
                <div class="stat-item">
                    <span class="label">Pertambahan Berat (kg)</span>
                    <span class="value">{{ $recentData['weight_gain'] ?? 0 }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="report-types">
        <div class="card">
            ...
            <div class="report-links">
                <a href="{{ route('reports.performance') }}" class="report-link">
                ...
                {{-- <a href="{{ route('reports.financial') }}" class="report-link">
                    <div class="report-icon">💰</div>
                    <div class="report-info">
                        <h4>Laporan Keuangan</h4>
                        <p>Analisis biaya dan pendapatan</p>
                    </div>
                </a> --}}

                <a href="{{ route('reports.growth') }}" class="report-link">
                    <div class="report-icon">📈</div>
                    <div class="report-info">
